...
const ReportIssue: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For now, just log and show success state
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-10">
        <div className="text-center mb-12">
          ...
          <p className={isDarkMode ? "text-gray-300" : "text-gray-600"}>
            Help us keep BlogNest safe and reliable — report bugs, abusive
            content, or other concerns.
          </p>
        </div>
        ...
        >
          ...
          <p className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
            Try reproducing the issue, capture screenshots, and note URLs or
            steps. For content issues, include links to the offending post.
          </p>
        </div>
        ...
        >
          <div className="mb-4">
            ...
            >
              <option value="content">
                Content violation (harassment/plagiarism)
              </option>
              <option value="bug">Bug / Technical issue</option>
              <option value="abuse">User abuse / Harassment</option>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full"
              placeholder="Choose a screenshot or image file"
            />
            {attachment && <p className="text-sm mt-2">{attachment.name}</p>}
          </div>
          ...
          {submitted && (
            <div className="mt-6 p-4 rounded-md bg-green-50 text-green-800">
              Thank you — your report has been submitted. Our team will review
              it shortly.
            </div>
          )}
        </form>
