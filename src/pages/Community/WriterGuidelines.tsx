      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        <div className="text-center mb-14">
          ...
          <p className={`text-lg max-w-2xl mx-auto ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
            Maintain clarity, accuracy, and respect — these guidelines help keep BlogNest high-quality and trustworthy.
          </p>
        </div>

        <div className={`p-8 rounded-xl shadow-sm border mb-10 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
          <h2 className="text-2xl font-semibold mb-4">Essential Rules</h2>
          <ul className={isDarkMode ? "text-gray-300 list-disc ml-6 space-y-2" : "text-gray-700 list-disc ml-6 space-y-2"}>
        ...
        <div className={`p-8 rounded-xl shadow-sm border text-center ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
          <h3 className="text-xl font-semibold mb-3">Editing & Review</h3>
          <p className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
            Posts might be reviewed for policy compliance. Minor edits may be applied for formatting or safety.
          </p>
        </div>
      </div>
    </div>
