  ...
  const sections = [
    {
      ...
      content: (
        <p className="text-sm">
          You must be at least <strong>13 years old</strong> to use BlogNest. By using the platform,
          you confirm that you meet this requirement and have the legal capacity to agree to these
          terms.
        </p>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p className="text-sm">
          You retain ownership of the content you create. By publishing on BlogNest, you grant us a
          license to display, distribute, and promote your content on the platform and related
          services.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-sm">
          BlogNest is provided “as is.” We are not responsible for losses caused by technical
          issues, misuse, data loss, or third-party actions related to your use of the platform.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-sm">
          We may suspend or terminate your account if you violate these terms, breach our policies,
          or harm the community or platform in any way.
        </p>
      ),
    },
  ];
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            By accessing or using <strong>BlogNest</strong>, you agree to follow these terms and
            conditions that keep the platform safe and fair.
          </p>
        </div>
        ...
        >
          ...
          <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
            These Terms of Service define your rights and responsibilities when using BlogNest,
            including content rules, platform rights, and what happens if policies are violated.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-14">
          {sections.map((section, idx) => (
            <TermsCard key={idx} isDarkMode={isDarkMode} icon={section.icon} title={section.title}>
              {section.content}
            </TermsCard>
          ))}
        </div>
        ...
        >
          <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            Using BlogNest means you accept these terms. If you do not agree, you should discontinue
            use of the platform.
          </p>
