...
import { Shield, UserCheck, Database, Share2, Lock, FileText, RefreshCcw } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-2">
            We collect information to improve our services and enhance your experience:
          </p>
          <ul className="list-disc ml-5 space-y-2">
            <li>
              <strong>Account Data:</strong> Name, email, username, and profile details.
            </li>
            <li>
              <strong>Content:</strong> Articles, comments, likes, drafts.
            </li>
            <li>
              <strong>Technical Data:</strong> IP, browser, device information.
            </li>
            <li>
              <strong>Cookies:</strong> For personalization and performance.
            </li>
          </ul>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <p>
          We use encryption, secure servers, and strict access controls to safeguard information
    ...
    },
    {
      ...
      content: (
        <p>
          This policy may be updated periodically. Continued use of BlogNest means you accept future
          terms.
        </p>
      ),
    },
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            Your privacy is important to us. This page explains how BlogNest collects, protects and
            uses your information responsibly.
          </p>
        </div>
        ...
        >
          ...
          <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
            This document details what information we collect, how we use it, security measures,
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-14">
          {sections.map((item, idx) => (
            <PrivacyCard key={idx} title={item.title} icon={item.icon} isDarkMode={isDarkMode}>
              {item.content}
            </PrivacyCard>
          ))}
        </div>
        ...
        >
          <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            BlogNest is committed to transparent data use. Feel free to contact us for privacy
