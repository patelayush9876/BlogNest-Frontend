  ...
  const sections = [
    {
      ...
      content: (
        <p className="text-sm">
          ...
          remember preferences, improve loading speed, and personalize experience.
        </p>
      ),
    },
    {
      ...
      content: (
        <ul className="list-disc ml-5 space-y-2 text-sm">
          <li><strong>Essential Cookies</strong> – enable login, navigation, and security.</li>
          <li><strong>Performance Cookies</strong> – track loading speed and feature usage.</li>
          <li><strong>Analytics Cookies</strong> – help us understand user activity.</li>
          <li><strong>Preference Cookies</strong> – remember theme and UI settings.</li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <p className="text-sm">
          You can disable cookies from your browser settings. However, some
          features of BlogNest may not function fully without them.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-sm">
          We may use third-party analytics or service tools that store cookies to
          enhance performance and platform insights.
        </p>
      ),
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          <p className={`text-lg max-w-2xl mx-auto ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
            Learn how BlogNest uses cookies to improve functionality, personalize
        ...
        >
          ...
          <p className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
            Cookies allow BlogNest to remember preferences, improve navigation,
            and provide a better reading and writing experience for users.
          </p>
        </div>
        ...
        >
          <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} text-sm`}>
            You can modify cookie settings anytime through your browser. Continued
            use of BlogNest implies consent to our cookie usage.
          </p>
