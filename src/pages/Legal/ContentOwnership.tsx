...
const ContentOwnership: React.FC = () => {
  ...
  const sections = [
      ...
      content: (
        <>
          <p className="text-sm mb-2">
            By publishing content on BlogNest, you grant a non-exclusive license allowing the platform to:
          </p>
          <ul className="list-disc ml-5 space-y-2 text-sm">
    ...
    },
    {
      ...
      content: (
        <p className="text-sm">
          Publishing plagiarized or copyright-infringing material may lead to
          removal or account suspension. Undisclosed AI-generated work may also
    ...
    },
    {
      ...
      content: (
        <p className="text-sm">
          If your work has been copied without permission, you may file a DMCA
          claim via the Report Issue page. We will review and take appropriate action.
        </p>
      ),
    },
  ];
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            BlogNest protects creators and ensures fair intellectual property rights.
            Here's how ownership works on the platform.
          </p>
        </div>
        ...
        >
          ...
          <p className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
            Creators own their work. BlogNest provides visibility and promotion
