    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            Turn complex engineering ideas into clear, structured articles that readers actually
            enjoy and learn from on <strong>BlogNest</strong>.
          </p>
        </div>
        ...
        >
          ...
          <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
            Effective technical writing transforms complex concepts into easy-to-follow knowledge.
            These tips help you craft meaningful and clear articles for readers at different skill
            levels.
          </p>
        </div>
        ...
        >
          <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            Improving writing is a continuous journey. Each published blog becomes a better version
            of your past work.
          </p>
