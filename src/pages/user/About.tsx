    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            A publishing space built for tech engineers — where knowledge, experience, and expertise
            turn into meaningful content.
          </p>
        </div>
        ...
        >
          ...
          <p className={`leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            BlogNest is a dedicated platform for technology professionals — software developers,
            network engineers, cloud architects, data engineers, AI/ML enthusiasts, cybersecurity
            experts, and learners in tech.
            <br />
            <br />
            Here, engineers can publish informative, factual, and insightful blogs about
            programming, tools, frameworks, architectures, networking concepts, industry best
            practices, and real-world engineering experiences.
            <br />
            <br />
            Whether you're sharing knowledge or learning from others, BlogNest is designed to help
            the tech community grow together.
          </p>
        </div>
        ...
        >
          ...
          >
            To create a platform where tech engineers can share knowledge, learn from each other,
            and contribute to the global engineering community — one insightful blog at a time.
          </p>
        </div>
      </div>
    </div>
